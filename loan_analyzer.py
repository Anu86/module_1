...
no_of_loans = len(loan_costs)
print(f"total number of loans: {no_of_loans}")
...
average_loan_amount = total_loan_amount/no_of_loans 
...
fair_value = future_value /(1 + (20/100)/12)  ** loan.get("remaining_months")
print(f"Present_value for loan : ${round(fair_value, 2)}")
...
if loan.get("loan_price") == fair_value: 
    print(f" The loan ${round(loan_price, 2)} is worth at least the cost ${round(fair_value, 2)}to buy it")
elif loan.get("loan_price") > fair_value: 
...
pv = calculate_present_value(new_loan.get("future_value"), new_loan.get("remaining_months"),0.2 )
print(f"The present value of the new loan is: {pv}")
...
for loan in loans:
    if loan.get("loan_price") < 500 or loan.get("loan_price") == 500: 
        loan_price = loan.get("loan_price")
        inexpensive_loans.append(loan)
        print(f"Loan amount {loan_price} is lesser or equal to $500")
    else:
        print(f"loan amount higher than $500")
